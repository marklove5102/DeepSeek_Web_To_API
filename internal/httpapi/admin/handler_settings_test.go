...
func TestUpdateSettingsPasswordInvalidatesOldJWT(t *testing.T) {
	...
	t.Setenv("DEEPSEEK_WEB_TO_API_JWT_SECRET", "admin-jwt-secret")
	...
	body := map[string]any{"new_password": "new-password123"}
	...
	if !authn.VerifyAdminCredential("new-password123", h.Store) {
