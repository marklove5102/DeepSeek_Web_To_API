...
func TestCORSPreflightAllowsThirdPartyRequestedHeaders(t *testing.T) {
	...
	req.Header.Set("Access-Control-Request-Headers", "authorization, x-stainless-os, x-stainless-runtime, x-deepseek-web-to-api-internal-token")
	...
	if strings.Contains(allowHeaders, "x-deepseek-web-to-api-internal-token") {
...
func TestBuildCORSAllowHeadersKeepsDefaultsWithoutRequest(t *testing.T) {
	...
	for _, want := range []string{"content-type", "x-goog-api-key", "anthropic-version", "x-deepseek-web-to-api-source"} {
