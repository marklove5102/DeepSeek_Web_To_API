...
import (
	...
	"DeepSeek_Web_To_API/internal/testsuite"
)
...
func main() {
	...
	flag.StringVar(&opts.AdminKey, "admin-key", opts.AdminKey, "Admin key (default: DEEPSEEK_WEB_TO_API_ADMIN_KEY, config admin.key, or admin)")
